...
import com.wushanghui.mapper.UserMapper;
import com.wushanghui.model.UserModel;
import com.wushanghui.util.UserUtil;
...
public class UserMapperTest {
    ...
    public void insert() throws Exception {
        ...
        Object o = UserUtil.callMapper(UserMapper.class, mapper -> {
    ...
    public void getModelListByIds() throws Exception {
        List<Integer> idList = new ArrayList<>(Arrays.asList(2, 3, 4));
        Map<String, Object> map = new HashMap<>();
